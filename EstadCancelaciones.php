...
NOMBRE: <input type="text" name="name123" id="name123" size="35" >
FECHA: <input type="text" name="name1234" id="name1234" >&nbsp&nbsp<button  type="submit" style="font-size:100%;background-color:#2D6DA6;color:white;font-weight: bold;">VALIDAR</button>
