...
if ($curlError) {
    ...
    echo "• La API no está corriendo (verificar que el backend esté ejecutándose)\n";
    echo "• En Docker: usar host.docker.internal:3000\n";
    echo "• En local: usar localhost:3000\n";
